...
class RecoleccionesPageWidget extends StatefulWidget {
  ...
  static String routeName = 'Recolecciones';
  static String routePath = '/recolecciones';

  @override
  State<RecoleccionesPageWidget> createState() => _RecoleccionesPageWidgetState();
}
    ...
    if (items.isEmpty) {
      return Center(
        child: Column(
          ...
          children: [
            Icon(Icons.scale_rounded, size: 48, color: const Color(0xFF08201A).withOpacity(0.2)),
            const SizedBox(height: 16),
            Text('No hay recolecciones $status', style: const TextStyle(color: Color(0xFF424846))),
          ],
        ),
      );
    }
