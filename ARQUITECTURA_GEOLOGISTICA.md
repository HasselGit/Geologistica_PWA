...
Se a�adi� la columna apicultor_id en la tabla parada_items (tipo TEXT) referenciando apicultores.id. La lectura de TCM se abstrajo exclusivamente a la tabla pesajes para soportar divisi�n en paradas multicliente.
