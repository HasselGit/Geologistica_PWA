# Reglas de Comunicaci贸n (Vercel)
- NUNCA imprimas ni muestres al usuario la URL autogenerada de Vercel (e.g. https://geologistica-jrj...vercel.app).
- Muestra 脷NICAMENTE la URL limpia y principal del proyecto (https://geologistica-pwa.vercel.app).

# Actualizaci贸n de Directrices
- Es vital mantener los archivos directrices (e.g. ARQUITECTURA_GEOLOGISTICA.md, design_tokens.dart) actualizados con cada decisi贸n. El objetivo final es que cualquier agente pueda clonar el proyecto desde cero bas谩ndose 煤nicamente en la documentaci贸n.
...
- El 03/07/2026, se modificaron lib/pages/homepage.dart y lib/pages/gerentehome.dart para corregir simetr韆 de m骴ulos y unificar colores en matriz de operaciones eliminando gr醘ica residual en Tambores.
