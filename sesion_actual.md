...
 # #   S i n c r o n i z a c i � n   M a n u a l  
 -   E j e c u c i � n   e s t r i c t a   d e l   p r o t o c o l o   d e   g u a r d a d o .  
 ## Sesion 24/07/2026 - Fix TCM y Supabase
- Se modific� agregaritem.dart para permitir la selecci�n manual de apicultor en Paradas.
- Se agreg� el campo apicultor_id en parada_items (via Supabase SQL).
- Se solucion� la duplicaci�n de rutas (choferHome / perfil) en main.dart.
- Se repar� el c�lculo de TCM en apicultor_detalle.dart para leer retroactivamente de pesajes.
- Se corrigi� error SQL al consultar remitos(apicultor_id) inexistente.
- Se arregl� la vista de pesajes_page.dart para que agrupe por parada_id y apicultor_id.
- Se actualiz� el listado de fallbackApicultores.
## Sesion 27/07/2026 - Fix Multi-Apicultor Remito Filter
- Se solucion� el problema en picultor_detalle.dart donde el perfil de Urrutia tra�a el remito de Zupan. Se restaur� picultor_id en la consulta emitos a Supabase para que el filtro en Dart funcione correctamente.
- Se solucion� el problema donde el perfil de Zupan aparec�a vac�o de remitos en la parada compartida. Se agreg� l�gica de rescate en _fetchDetailedData para que tambi�n busque la existencia de remitos y pesajes a su nombre, logrando as� recuperar la informaci�n de la parada compartida correctamente.
