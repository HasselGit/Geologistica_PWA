...
const url = 'https://suwcqdlxnmfcvmlnzizl.supabase.co/rest/v1/remitos?select=*,paradas(*,solicitudes(*,apicultores(*)),parada_items(*))&limit=2';
const options = {
  headers: {
...
https.get(url, options, (res) => {
  ...
  res.on('end', () => {
    try {
      ...
      console.log('--- NESTED REMITOS SAMPLE ---');
